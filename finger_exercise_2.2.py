...
if x % 2 == 0 and y % 2 == 0 and z % 2 == 0:
    ...
    if y > z:
        ...
        print('y and z are equal and are the largest odd numbers')
    else:
    ...
    if x > z:
        ...
        print('x and z are equal and are the largest odd numbers')
    else:
        print('z is the largest odd number')
elif z % 2 == 0:
    if x > y:
        ...
        print('x and y are equal and are the largest odd numbers')
    else:
        print('z is the largest odd number')
